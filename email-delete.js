...
(() => {
    ...
    const button = document.querySelector('[data-email-delete-button]');
    const status = document.querySelector('[data-email-delete-status]');
    const panel = document.querySelector('[data-email-delete-panel]');
    const complete = document.querySelector('[data-email-delete-complete]');
