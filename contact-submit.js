...
roadmapLinks.forEach(link=>{link.href='./roadmap.html';link.removeAttribute('data-placeholder-link');});
const preregisterLinks=[...document.querySelectorAll('a')].filter(link=>link.textContent.trim()==='事前登録');
preregisterLinks.forEach(link=>{link.href='./preregister.html';link.removeAttribute('data-placeholder-link');});
const crowdfundingLinks=[...document.querySelectorAll('a')].filter(link=>link.textContent.trim()==='クラウドファンディング');
crowdfundingLinks.forEach(link=>{link.href='./crowdfunding.html';link.removeAttribute('data-placeholder-link');});
const faqLinks=[...document.querySelectorAll('a')].filter(link=>link.textContent.trim()==='FAQ');
faqLinks.forEach(link=>{link.href='./faq.html';link.removeAttribute('data-placeholder-link');});
